...
router.put("/update/:id",authMiddleware, authorize("admin","teacher"),uploadCourse.single("thumbnail"),courseController.updateCourse);

router.delete("/delete/:id",authMiddleware,authorize("admin","teacher"),  courseController.deleteCourse);
